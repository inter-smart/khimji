...
const BlogBanner = dynamic(
  () => import("@/components/features/blog/BlogBanner"),
);
const BlogList = dynamic(() => import("@/components/features/blog/BlogList"));
const BlogListSkeleton = dynamic(
  () => import("@/components/layout/Skeletons/BlogListSkeleton"),
);
...
export async function generateMetadata({ params }) {
  ...
  const {
    ...
    alternates,
    other,
  } = await getMetaData("blogs?page=news  ", lang, "blog");
...
export default async function Page({ params, searchParams }) {
  ...
  const {
    ...
    structuredData,
    lineScripts,
  } = await getData("blogs?page=news", lang);
    ...
    <>
      ...
      <Suspense fallback={<BlogListSkeleton />}>
        <BlogList
          variant="news"
          lang={lang}
          searchParams={resollvedSearchParams}
        />
      </Suspense>
    </>
  );
