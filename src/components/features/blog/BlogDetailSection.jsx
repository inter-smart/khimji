...
export default function BlogDetailSection({ data }) {
    return (
        <section className="w-full h-auto py-[30px] sm:py-[50px_70px] lg:py-[65px_80px] 2xl:py-[110px_120px] 3xl:py-[135px_160px] block relative z-0">
            ...
            <div className="w-[170px] sm:w-[220px] 2xl:w-[285px] 3xl:w-[370px] h-auto aspect-square bg-[#1A9BF5] rounded-full blur-[50px] sm:blur-[80px] 2xl:blur-[180px] opacity-40 absolute -z-1 inset-[15%_0_auto_auto]"></div>
            <div className="w-[170px] sm:w-[220px] 2xl:w-[285px] 3xl:w-[370px] h-auto aspect-square bg-[#1A9BF5] rounded-full blur-[50px] sm:blur-[80px] 2xl:blur-[150px] opacity-40 absolute -z-1 inset-[35%_auto_auto_-10%]"></div>
            <div className="container">
                ...
                <div className="group w-full h-auto aspect-[1640/590] mb-[30px] sm:mb-[40px] lg:mb-[50px] 2xl:mb-[60px] 3xl:mb-[80px] rounded-[5px] sm:rounded-[7px] 2xl:rounded-[10px] overflow-hidden block">
                    <Image
                        ...
                        alt={data?.media?.alt || "Blog Detail"}
                        width={1640}
                        height={590}
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                    />
                </div>
                <div className="text-[12px] sm:text-[14px] 2xl:text-[15px] 3xl:text-[16px] leading-[1] font-normal text-white w-fit p-[5px_15px] sm:p-[5px_20px] 2xl:p-[10px_25px] mb-[20px] sm:mb-[30px] 2xl:mb-[35px] 3xl:mb-[50px] bg-linear-to-r from-[#0B436A] to-[#299B8A] rounded-full">{data?.date}</div>
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: data?.text_editor_content }}
                />
            </div>
        </section>
    );
