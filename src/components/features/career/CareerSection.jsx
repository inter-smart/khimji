                                            ...
                                            <div
                                                ...
                                                <Dialog className="w-full">
                                                    ...
                                                    <DialogContent className="lg:max-w-[600px] 2xl:max-w-[720px] 3xl:max-w-[900px] sm:p-[40px] lg:p-[50px] 2xl:p-[60px] 3xl:p-[80px] max-h-[100vh]      overflow-y-auto">
                                                        <DialogTitle className="text-[18px] sm:text-[20px] 2xl:text-[25px] 3xl:text-[32px] leading-[1] font-normal bg-gradient-to-r from-[#0B436A] to-[#299B8A] bg-clip-text text-transparent w-fit uppercase mb-[15px] sm:mb-[20px] lg:mb-[30px] 2xl:mb-[35px] 3xl:mb-[50px]">Fill the form below</DialogTitle >
                                                        <CareerForm />
                                                    </DialogContent>
                                                </Dialog>
                                            </div>
