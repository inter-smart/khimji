              ...
              <div className="relative mt-[20px]">
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex gap-2">
                  ...
                  >
                    <svg width="14" height="13" viewBox="0 0 14 13">
                      <path
                        d="M13.4042 6.76385C13.7315 6.43657 13.7315 5.90596 13.4042 5.57868L8.07099 0.245433C7.74372 -0.0818413 7.2131 -0.0818413 6.88583 0.245433C6.55855 0.572708 6.55855 1.10332 6.88583 1.4306L11.6265 6.17126L6.88583 10.9119C6.55855 11.2392 6.55855 11.7698 6.88583 12.0971C7.2131 12.4244 7.74372 12.4244 8.07099 12.0971L13.4042 6.76385ZM0 6.17126V7.0093H12.8117V6.17126V5.33323H0V6.17126Z"
                        fill="white"
                      />
                    </svg>
                  </button>
