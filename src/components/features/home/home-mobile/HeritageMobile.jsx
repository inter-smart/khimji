          ...
          <div className="flex flex-wrap -m-[4px] xs:-m-[9px] mt-[30px]">
            {metrics?.map((item, index) => (
              <div key={item?.key} className="w-1/2 p-[4px] xs:p-[9px]">
                <div
                  className=" w-full h-full backdrop-blur-[2px] rounded-[10px] p-[10px] xs:p-[12px] border border-white/35 shadow-[inset_-2px_-1px_3px_#f1f1f14a,inset_1px_1px_0px_#fafafa6e]"
                >
