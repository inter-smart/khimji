...
export default function BannerSection() {
  return (
    <section className="py-[60px_40px] xl:py-[90px_40px] 2xl:py-[115px_40px] 3xl:py-[145px_60px]">
      <div className="container">
        <div className="flex flex-wrap -m-[8px]">
          <div className="w-4/12 p-[8px] flex items-center">
            <div className="w-full">
              <div className="sm:text-[25px] md:text-[30px] lg:text-[50px] xl:text-[60px] 2xl:text-[80px] 3xl:text-[100px] text-[#0B436A] font-medium leading-[30px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[80px] 3xl:leading-[100px] uppercase mb-[20px]">
                KhimJi
                <span className="text-[#299B8A] block">ramdas</span>
              </div>
              <p className="mb-[15px]">
          ...
          <div className="w-8/12 p-[8px]">
            <div className="max-w-[1075px] w-full relative">
              <video
                autoPlay
                loop
                muted
