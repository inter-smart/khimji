...
export default function BannerSection() {
  return (
    <>
      <section className="py-[60px_40px] xl:py-[90px_40px] 2xl:py-[115px_40px] 3xl:py-[145px_60px] overflow-hidden max-sm:hidden">
      ...
      <section className="w-full relative h-screen sm:hidden z-0 before:absolute before:top-0 before:content-[''] before:bottom-0 before:w-full before:h-full before:bg-gradient-to-t before:from-black  before:to-black/0 before:opacity-[0.5]">
        <Image src="/images/mobilebanner.jpg" className="w-full h-full object-cover absolute top-0 left-0 -z-1 " width="440" height="930" alt="mobileBanner" />
        <div className="container flex items-end h-full py-[60px]">
          <div className="realtive z-1 w-full">
            <div className="text-[40px] xs:text-[50px] text-white font-medium mb-[10px] uppercase leading-[45px] xs:leading-[55px]">
              KhimJi <br />
              ramdas</div>
            <p className="text-[16px] xs:text-[20px] text-white max-w-[90%] mb-[25px] xs:mb-[35px]">Shaping Oman’s growth and enriching lives with heritage, innovation, and trusted global partnerships since 1870</p>
            <Link href="#!" className="text-[16px] xs:text-[18px] text-white font-medium w-fit flex items-center justify-center h-[40px] xs:h-[50px] min-w-[160px] xs:min-w-[180px] p-[8px] border border-white">Discover More
