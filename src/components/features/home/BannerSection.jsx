            ...
            <div className="w-4/12 p-[8px] flex items-center">
              <div className="w-full">
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                >
                  Shaping {countryData.name}'s growth and enriching lives with heritage, innovation, and trusted global partnerships since 1870
                </motion.p>
        ...
        <div className="container flex items-end h-full py-[60px]">
          <div className="relative z-1 w-full">
            <div className="text-[40px] xs:text-[50px] text-white font-medium mb-[10px] uppercase leading-[45px] xs:leading-[55px]">
              KhimJi <br />
              ramdas</div>
            <p className="text-[16px] xs:text-[20px] text-white max-w-[90%] mb-[25px] xs:mb-[35px]">Shaping {countryData.name}’s growth and enriching lives with heritage, innovation, and trusted global partnerships since 1870</p>
