...
export default function ArchiveSection() {
    ...
    useEffect(() => {
        ...
        try {
            const data = [
                {
                    lat: currentItem.coordinates.lat,
                    lng: currentItem.coordinates.lng,
            ...
            <div className="container">
                ...
                <div className="relative">
                    <div className="relative mb-8 w-full max-w-[650px] !h-[650px] m-auto bg-white after:absolute after:content-[''] after:bottom-0 after:left-0 after:right-0 after:bg-white after:w-full after:h-[270px]">
                        ...
                        {/* Custom SVG marker overlay - we'll position this dynamically */}
                        {globeReady && currentItem && (
                            <div
                                className="absolute z-20 transition-all duration-1500"
                                style={{
                                        ...
                                        <div className="flex flex-wrap -m-[8px]">
                                                ...
                                                <div className="flex items-center">
                                                    <div className={icons}>
                                                        <svg className="max-w-[22px]" viewBox="0 0 22 22" fill="none" >
                                                            <g clip-path="url(#clip0_1342_3911)">
                                                                <path d="M22 6.61036V5.52754V1.52973H19.2053V0.271606H18.1225V1.52973H14.0972V0.271606H13.0144V1.52973H8.98562V0.271606H7.90281V1.52973H3.8775V0.271606H2.79469V1.52973H0V5.53098V6.61379V21.7319H22V6.61036ZM1.08281 2.60911H2.79469V3.83973H3.8775V2.60911H7.90625V3.83973H8.98906V2.60911H13.0178V3.83973H14.1006V2.60911H18.1294V3.83973H19.2122V2.60911H20.9241V5.52754H1.08281V2.60911ZM20.9172 20.6491H1.08281V6.61036H20.9172V20.6491Z" fill="black" />
                                                    ...
                                                    <div className={iconBlock}>
                                                        <div className={textcontent}>{currentItem.date}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="w-3/5 p-[8px]">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className={iconBlock}>
                                                        <div className={textcontent}>{currentItem.title}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="w-2/5 p-[8px]">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className={iconBlock}>
                                                        <div className={textcontent}>{currentItem.location}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="w-3/5 p-[8px]">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className={iconBlock}>
                                                        <div className={textcontent}> {currentItem.link}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
