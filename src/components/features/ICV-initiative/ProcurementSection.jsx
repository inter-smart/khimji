...
export default function ProcurementSection() {
    ...
    const procurementData = [
        ...
        },
        {
            ...
            title: "Omani team & products engaged for interior project at SQU Hospital",
            details: [
                {
                    label: "Client :",
                    value: "Royal Court Affairs",
