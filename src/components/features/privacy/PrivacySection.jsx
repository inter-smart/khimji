    ...
    return (
        <section className="w-full h-auto py-[30px] sm:py-[50px_70px] lg:py-[65px_80px] 2xl:py-[110px_120px] 3xl:py-[135px_100px] max-sm:mt-[150px] block relative z-0">
            ...
            <div className="container">
                <div className="text-[18px] sm:text-[24px] lg:text-[34px] 2xl:text-[40px] 3xl:text-[100px] leading-[1.2] font-normal text-[#0B436A] mb-[10px]"> {data?.title?.split(" ").map((item, index) => (
                    <span
                        key={index}
