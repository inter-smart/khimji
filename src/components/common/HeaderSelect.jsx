                ...
                <div className="relative inline-flex rounded-full">
                    <Select>
                        <SelectTrigger
                            className="
                          relative
                          text-[16px] 3xs:text-[18px] lg:text-[12px] 2xl:text-[14px] 3xl:text-[18px] text-white sm:text-black font-medium max-w-full min-h-[30px] 2xl:min-h-[35px] 3xl:min-h-[45px] px-3 sm:px-2 
                          border border-white/5 sm:border-black min-w-[115px] lg:min-w-[125px] rounded-[40px] sm:rounded-[5px]
                          outline-none shadow-none focus:outline-none focus:ring-0 focus:shadow-none backdrop-blur-[8px]
