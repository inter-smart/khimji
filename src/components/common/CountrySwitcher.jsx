          ...
          <div className="absolute top-full mt-2 left-0 bg-white border border-gray-300 rounded-lg shadow-lg z-20 min-w-[200px]">
            {countries.map((country) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-100 transition-colors first:rounded-t-lg last:rounded-b-lg ${currentCountry.code === country.code ? 'bg-blue-50' : ''
                  }`}
              >
                ...
                {currentCountry.code === country.code && (
                  <svg
                    className="w-5 h-5 ms-auto text-blue-600"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
